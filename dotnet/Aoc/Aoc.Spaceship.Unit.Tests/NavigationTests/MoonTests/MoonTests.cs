...
namespace Aoc.Spaceship.Unit.Tests.NavigationTests.MoonTests
{
    ...
    public class MoonTests
    {
        ...
        public void Can_calculate_velocity_from_for_1_step()
        {
            ...
            //Check velocity 
            Assert.AreEqual(3, planetarySystem.XAxis.Velocities[0]);
            Assert.AreEqual(-1, planetarySystem.YAxis.Velocities[0]);
            Assert.AreEqual(-3, planetarySystem.YAxis.Velocities[3]);
            //Check positions
            Assert.AreEqual(2, planetarySystem.XAxis.Positions[0]);
            Assert.AreEqual(-1, planetarySystem.YAxis.Positions[0]);
            Assert.AreEqual(2, planetarySystem.YAxis.Positions[3]);
            Assert.AreEqual(3, planetarySystem.XAxis.Positions[1]);
        }

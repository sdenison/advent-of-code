...
class IntcodeComputer(object):
    ...
    def __get_next_instruction(self):
    ...
    def __execute_jump_instruction(self, instruction):
    ...
    def __execute_compare_instruction(self, instruction):
        parameter1 = self.__get_parameter_value(instruction, 1)
        parameter2 = self.__get_parameter_value(instruction, 2)
    ...
    def __execute_math_instruction(self, instruction):
        parameter1 = self.__get_parameter_value(instruction, 1)
        parameter2 = self.__get_parameter_value(instruction, 2)
    ...
    def __execute_display_instruction(self, instruction):
        self._Output.append(self._memory[self._memory[(self._instruction_pointer + 1)]])

    def __execute_put_instruction(self, instruction):
    ...
    def __get_parameter_value(self, instruction, parameter_position):
    ...
    def __initialize(self, program, user_input):
